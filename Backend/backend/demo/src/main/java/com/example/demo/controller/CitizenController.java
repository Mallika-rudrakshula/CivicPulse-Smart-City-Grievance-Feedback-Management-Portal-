...
public class CitizenController {
    ...
    // ================== PROFILE ==================
    @GetMapping("/profile")
    public Citizen getProfile(HttpServletRequest request) {
        Citizen citizen = getCitizenFromRequest(request);
        return citizenService.getProfile(citizen.getId());
    }
    ...
    public Citizen updateProfile(
        ...
        Citizen citizen = getCitizenFromRequest(request);
        return citizenService.updateProfile(citizen.getId(), updatedCitizen);
    }
}
